...
function contain() {
  ...
  function runAction(props, context, action) {
    ...
    !Array.isArray(actionArgs) ? process.env.NODE_ENV !== 'production' ? (0, _invariant2.default)(false, name + ' getActionArgs should return an array but got ' + actionArgs) : (0, _invariant2.default)(false) : void 0;
  ...
  return _temp = _class = function (_React$Component) {
    ...
    _createClass(Container, [{
      ...
      value: function componentWillMount() {
        ...
        !isActionable ? process.env.NODE_ENV !== 'production' ? (0, _invariant2.default)(false, options.fetchAction + ' should return a function but got ' + action + '.\n          Check the fetch options for ' + name + '.') : (0, _invariant2.default)(false) : void 0;
